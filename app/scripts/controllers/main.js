	...
	.controller('choisirUnPrenomCtrl', ['$scope', '$window', 'donneMoiDesPrenoms' ,function ($scope, $window, donneMoiDesPrenoms) {
		...
		$scope.persisterDansLeLocalStorage = function() {
			if(typeof($window.Storage) !== 'undefined') {
				$window.localStorage.setItem('nom', $scope.nom);
				$window.localStorage.setItem('sexe', $scope.sexe);
				$window.localStorage.setItem('listeDesPrenomsGardes', JSON.stringify($scope.listeDesPrenomsGardes));
				$window.localStorage.setItem('listeDesPrenomsRejetes', JSON.stringify($scope.listeDesPrenomsRejetes));
			}
		};

		$scope.chargerDepuisLeLocalStorage = function() {
			if(typeof($window.Storage) !== 'undefined') {
				var nomStorage = $window.localStorage.getItem('nom');
